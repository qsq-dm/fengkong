...
//print_r($result[0]["ImgName"]);

/*$mysqli = new mysqli('118.186.244.101','luocheng','finsys512','huayu_sales_bj');
$mysqli->set_charset('utf8');
$sql = "update sales_userinfo set photo = '{$result[0]['ImgName']}' where uid = ".$_SESSION['uid'];
$mysqli->query($sql);*/
